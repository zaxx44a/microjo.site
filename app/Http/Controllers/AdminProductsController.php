<?php namespace App\Http\Controllers;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Categories Id","name"=>"categories_id","join"=>"categories,name"];
			$this->col[] = ["label"=>"P Name","name"=>"p_name"];
			$this->col[] = ["label"=>"P Code","name"=>"p_code"];
			$this->col[] = ["label"=>"P Color","name"=>"p_color"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Categories Id','name'=>'categories_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'categories,name'];
			$this->form[] = ['label'=>'P Name','name'=>'p_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'P Code','name'=>'p_code','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'P Color','name'=>'p_color','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
