            ...
            <div class="row">
                    ...
                    <div class="chose_area" style="padding: 20px;">
                        <form action="{{url('/apply-coupon')}}" method="post" role="form">
                            ...
                            <div class="form-group">
                                <label for="coupon_code">كوبون الخصم</label>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="total_area">
                        ...
                        <div style="margin-left: 20px;"><a class="btn btn-default check_out" href="{{url('/check-out')}}">تنفيذ وخروج</a></div>
                    </div>
                </div>
            </div>
        </div>
